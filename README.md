...
The code is tested in Python3.7 + PyTorch1.2 environment with one V100 GPU and the overall code framework is adapted from the [Superevent](https://github.com/piergiaj/super-events-cvpr18).
