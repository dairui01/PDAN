...
parser.add_argument('-network', type=str, default='PDAN')
...
if __name__ == '__main__':
	...
	if args.train:
		...
		if args.model=="PDAN":
			...
			if args.network=='PDAN':
				from PDAN import PDAN
			if args.network=='PDAN_light':
				from PDAN_light import PDAN
			if args.network=='PDAN_mixer':
				from PDAN_mixer import PDAN
			if args.network=='PDAN_visionpermutator':
				from PDAN_visionpermutator import PDAN
